...
import net.ladysnake.permafrozen.item.PermafrozenAxeItem;
import net.ladysnake.permafrozen.item.PermafrozenHoeItem;
import net.ladysnake.permafrozen.item.PermafrozenPickaxeItem;

import java.util.LinkedHashMap;
import java.util.Map;

import static net.ladysnake.permafrozen.registry.PermafrozenArmorMaterials.WULFRAM_ARMOR_MATERIAL;
...
public class PermafrozenItems {
	...
	public static final FoodComponent SPECTRAL_STUFF = new FoodComponent.Builder().alwaysEdible().hunger(1).statusEffect(new StatusEffectInstance(PermafrozenStatusEffects.SPECTRAL_DAZE, 2400, 0), 1.0f).build();
