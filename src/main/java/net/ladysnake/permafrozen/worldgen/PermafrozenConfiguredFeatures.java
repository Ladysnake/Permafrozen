...
public class PermafrozenConfiguredFeatures {
    ...
    public static final ConfiguredFeature<RandomPatchFeatureConfig, ?> GLAUCA_PATCH = register("glauca_patch", Feature.RANDOM_PATCH.configure(createRandomPatchConfig(BlockStateProvider.of(PermafrozenBlocks.GLAUCA_GRASS), 32)));
	...
	public static final PlacedFeature GLAUCA_PATCHES = register("glauca_patches", GLAUCA_PATCH.withPlacement(VegetationPlacedFeatures.modifiers(4)));
