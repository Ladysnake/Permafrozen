...
public class PermafrozenPlacedFeatures {
	...
	public static final PlacedFeature SPECTRAL_CAP_PATCHES = register("spectral_cap_patches", PermafrozenConfiguredFeatures.SPECTRAL_CAP_PATCH.withPlacement(modifiersWithChance(2, null)));
