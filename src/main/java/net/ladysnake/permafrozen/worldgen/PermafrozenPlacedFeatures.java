...
public class PermafrozenPlacedFeatures {
	...
	public static final PlacedFeature FRIGID_FEN_VEGETATION = register("frigid_fen_vegetation", PermafrozenConfiguredFeatures.DEADWOOD_TREE.withPlacement(VegetationPlacedFeatures.modifiers(PlacedFeatures.createCountExtraModifier(2, 0.1f, 1))));
