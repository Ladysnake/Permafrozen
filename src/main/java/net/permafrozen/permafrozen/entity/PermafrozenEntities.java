...
public class PermafrozenEntities {
	...
	public static final EntityType<TerraformBoatEntity> FIR_BOAT = createEntity("fir_boat", FabricEntityTypeBuilder.<TerraformBoatEntity>create(SpawnGroup.MISC, (type, world) -> new TerraformBoatEntity(type, world, new TerraformBoat(PermafrozenItems.FIR_BOAT, PermafrozenBlocks.FIR_PLANKS.asItem(), new Identifier(Permafrozen.MOD_ID, "textures/entity/boat/fir.png")))).dimensions(EntityType.BOAT.getDimensions()).build());
