...
public class PermafrozenBlocks {
    ...
    public static final Block STRIPPED_FIR_LOG = create("stripped_fir_log", createLogBlock(MapColor.SPRUCE_BROWN, MapColor.SPRUCE_BROWN), ItemGroup.BUILDING_BLOCKS);
    ...
    public static final Block FIR_FENCE = create("fir_fence", new FenceBlock(AbstractBlock.Settings.of(Material.WOOD, FIR_PLANKS.getDefaultMapColor()).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), ItemGroup.BUILDING_BLOCKS);
    public static final Block FIR_STAIRS = create("fir_stairs", new MojangWHYStairsBlock(FIR_PLANKS.getDefaultState(), AbstractBlock.Settings.copy(FIR_PLANKS)), ItemGroup.BUILDING_BLOCKS);
    public static final Block FIR_SLAB = create("fir_slab", new SlabBlock(AbstractBlock.Settings.of(Material.WOOD, MapColor.SPRUCE_BROWN).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), ItemGroup.BUILDING_BLOCKS);
