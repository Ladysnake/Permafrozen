...
public class PermafrozenConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> PATCH_SPECTRAL_CAP = register("patch_spectral_cap", Feature.RANDOM_PATCH.configure((new net.minecraft.world.gen.feature.RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(PermafrozenBlocks.SPECTRAL_CAP.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(8).build()));
