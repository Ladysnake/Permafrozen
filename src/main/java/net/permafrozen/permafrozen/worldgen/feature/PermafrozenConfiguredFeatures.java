...
public class PermafrozenConfiguredFeatures {
	...
	public static final ConfiguredFeature<TreeFeatureConfig, ?> FIR = register("fir", Feature.TREE.configure((new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(new SimpleBlockStateProvider(PermafrozenBlocks.FIR_LOG.getDefaultState()), new StraightTrunkPlacer(10, 6, 4), new SimpleBlockStateProvider(PermafrozenBlocks.FIR_LEAVES.getDefaultState()), new SimpleBlockStateProvider(PermafrozenBlocks.FIR_SAPLING.getDefaultState()), new SpruceFoliagePlacer(UniformIntProvider.create(2, 3), UniformIntProvider.create(0, 2), UniformIntProvider.create(5, 8)), new TwoLayersFeatureSize(2, 0, 2))).ignoreVines().dirtProvider(new SimpleBlockStateProvider(PermafrozenBlocks.MOSSY_PERMAFROST.getDefaultState())).build()));
	public static final ConfiguredFeature<TreeFeatureConfig, ?> MEGA_FIR = register("big_fir", Feature.TREE.configure((new net.minecraft.world.gen.feature.TreeFeatureConfig.Builder(new SimpleBlockStateProvider(PermafrozenBlocks.FIR_LOG.getDefaultState()), new GiantTrunkPlacer(18, 6, 15), new SimpleBlockStateProvider(PermafrozenBlocks.FIR_LEAVES.getDefaultState()), new SimpleBlockStateProvider(PermafrozenBlocks.FIR_SAPLING.getDefaultState()), new MegaPineFoliagePlacer(ConstantIntProvider.create(0), ConstantIntProvider.create(0), UniformIntProvider.create(13, 17)), new TwoLayersFeatureSize(1, 1, 2))).dirtProvider(new SimpleBlockStateProvider(PermafrozenBlocks.MOSSY_PERMAFROST.getDefaultState())).build()));
